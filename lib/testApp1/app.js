...
var options = {
  dirs: {
    routes: path.join(process.cwd(), 'lib', 'testApp1', 'routes'),
    middleware: path.join(process.cwd(), 'lib', 'testApp1', 'middleware'),
    handlers: path.join(process.cwd(), 'lib', 'testApp1', 'handlers')
  }
};

var app = module.exports = routes_builder(express(), options);
