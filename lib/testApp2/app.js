...
var options = {
  dirs: {
    routes: path.join(process.cwd(), 'lib', 'testApp2', 'routes'),
    middleware: path.join(process.cwd(), 'lib', 'testApp2', 'middleware'),
    handlers: path.join(process.cwd(), 'lib', 'testApp2', 'handlers')
  }
};
